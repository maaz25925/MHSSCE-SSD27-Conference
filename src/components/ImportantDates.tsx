      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-6 min-w-max">
          {dates.map((item, index) => (
            <div
              key={index}
              className={`bg-white rounded-lg shadow-md overflow-hidden transform transition-all hover:scale-105 hover:shadow-lg w-56 flex flex-col ${
            ...
            >
              {/* Header */}
              <div
                className={`bg-gradient-to-r ${item.color} p-4 text-white h-24 flex flex-col justify-center`}
              >
